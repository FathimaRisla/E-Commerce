...
<script src='https://kit.frontawesome.com/a076d05399.js'></script>
</head>
          <!-- -Header- -->
          <br>
          ...
          <a href="allProductEditProduct.jsp">All Products and Edit Proudcts<i class='fab fa-elementor'></i></a>
